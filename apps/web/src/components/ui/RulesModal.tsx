          ...
          >
            ...
            <section>
              ...
              <p className="text-sm leading-6 text-stone-700">
                親と子がそれぞれ3個のサイコロを振り、役の強さで勝負します。役なしのときは最大3回まで振り直せます。ラウンドごとに親が交代します。同じ強さの役は親の勝ちになります。
              </p>
              <p className="mt-2 text-sm leading-6 text-stone-700">
                選択固定モードでは、子は振る前に賭け金1〜3ptを選びます。ランダムモードでは能力を知ってから賭けると有利になりすぎるため、まず親が賭けの上限を宣言し、子は全員同時に（他の子の賭けを見ずに）賭け金を決め、全員が決め終わってから能力が発表されて、賭けの低い子から順に振ります。
              </p>
            </section>
